...
private:
    [[nodiscard]] static std::string generateStatesString(const std::set<int>& states);
    [[nodiscard]] static std::vector<std::string> generateStatesVector(const std::vector<std::shared_ptr<State>>& states);
